...
This project started when Jc encountered daily frustrations using a Logitech G309 gaming mouse on a MacBook Pro.

- The G309 is a gaming mouse — it doesn't support Logi Options+, so there was no way to **reverse scroll direction** natively.
...
Instead of installing three separate utilities, Jc built a single lightweight menu bar app to solve all three problems.
